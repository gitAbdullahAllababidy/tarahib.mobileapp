...
class AlreadySentInvitesDataObject extends Equatable {
	final int? id;
	final int? userId;
	...
	const AlreadySentInvitesDataObject({
		this.id, 
		this.userId, 
		this.randomCode, 
		this.qrcode, 
	...
	factory AlreadySentInvitesDataObject.fromMap(Map<String, dynamic> data) {
		return AlreadySentInvitesDataObject(
			id: data['id'] as int?,
			userId: data['user_id'] as int?,
			randomCode: data['random_code'] as String?,
			qrcode: data['qrcode'] as dynamic,
  ...
  /// `dart:convert`
  ///
  /// Parses the string and returns the resulting Json object as [AlreadySentInvitesDataObject].
	factory AlreadySentInvitesDataObject.fromJson(String data) {
		return AlreadySentInvitesDataObject.fromMap(json.decode(data) as Map<String, dynamic>);
	}
  /// `dart:convert`
  ///
  /// Converts [AlreadySentInvitesDataObject] to a JSON string.
	String toJson() => json.encode(toMap());

	AlreadySentInvitesDataObject copyWith({
		int? id,
		int? userId,
		String? randomCode,
		dynamic qrcode,
